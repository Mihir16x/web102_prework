...
contributionsCard.innerHTML = `<p>${totalIndividualContributions}</p>`;
...
raisedCard.innerHTML = `<p>$${totalAmountRaised.toLocaleString()}</p>`;


// grab number of games card and set its inner HTML
const gamesCard = document.getElementById("num-games");

gamesCard.innerHTML = `<p>${GAMES_JSON.length} Games</p>`;
...
const unfundedGamesString = `We currently have ${
    numUnfundedGames > 0 ? `${numUnfundedGames} unfunded games` : "no unfunded games"
  }.`;


// create a new DOM element containing the template string and append it to the description container
const fundraisingInfoElement = document.createElement("p");
fundraisingInfoElement.textContent = unfundedGamesString;
